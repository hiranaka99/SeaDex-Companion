...
function IntegrationCard({ icon, title, description, configured, connection, onTest, children }: { icon: IconName; title: string; description: string; configured: boolean; connection: ConnectionState; onTest: () => void; children: ReactNode }) {
