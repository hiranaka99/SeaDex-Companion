...
export const buttonBase =
  'inline-flex cursor-pointer items-center gap-[9px] whitespace-nowrap rounded-control border px-[18px] py-[11px] text-[14.5px] font-bold transition-all duration-150 disabled:cursor-not-allowed disabled:opacity-55'
...
export const control =
  'rounded-control border border-line bg-panel px-3.5 py-2.5 text-sm text-ink outline-none transition-[border-color,box-shadow] duration-150 focus:border-accent focus:shadow-[0_0_0_3px_rgba(79,140,255,0.15)]'
